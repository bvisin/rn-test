...
module.exports = {
  ...
  settings: {
    react: {
      version: 'detect',
      flowVersion: require('./package.json')['flow-bin']
    },
    'import/resolver': {
      'babel-module': {
        root: ['./src']
  ...
  globals: {
    ...
    SettingsTab: false,
    MyAccountLink: false,
    OnboardingHeader: false,
    MaybeLater: false,
    EditGoal: false,
    UpdateGoalField: false,
    HomeScreenGoalStatus: false,
    FindYourFirstWorkout: false,
    login: false,
    randomName: false,
    signUp: false,
    bypass: false,
  ...
  rules: {
    ...
    'complexity': ['warn', {'max': 9}], // specify the maximum cyclomatic complexity allowed in a program (off by default)
    ...
    'max-depth': [2, { max: 5 }], // specify the maximum depth that blocks can be nested (off by default)
